...
{
    public partial class XtraReportOpenCustomerEditListDealerSummary : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportOpenCustomerEditListDealerSummary()
        {
            InitializeComponent();
        }
