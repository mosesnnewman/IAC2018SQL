...
namespace IAC2018SQL
{
    public partial class frmCreateTSBExtract : Form
    {
        ...
        private void frmCreateTSBExtract_Load(object sender, EventArgs e)
        {
            ...
            IACDataSetTableAdapters.ClosedCreditManagerTableAdapter ClosedCreditManagerTableAdapter = new IACDataSetTableAdapters.ClosedCreditManagerTableAdapter();
            ...
            TempData.Dispose();
            ClosedCreditManagerTableAdapter.Dispose();
        }
        ...
        private void worker_LoadCustomerCreditManager(object sender, DoWorkEventArgs e)
        {
           ...
           ClosedCreditManagerBindingSource.DataSource = TSBDATA.ClosedCreditManager;
           ...
           for (Int32 i = 0; i < TSBDATA.CUSTOMER.Rows.Count; i++)
           {
               ...
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_FIRST_NAME", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_FIRST_NAME").Replace(@"'", ""));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_LAST_NAME",  TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_LAST_NAME").Replace(@"'", ""));
                // Moses Newman 06/05/2020 Add MiddleName
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("MiddleName", (TSBDATA.CUSTOMER.Rows[i].Field<String>("MiddleName") != null) ? TSBDATA.CUSTOMER.Rows[i].Field<String>("MiddleName").Replace(@"'", "") : "");
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_SS_NUMBER",
               ...
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_PHONE_NO",
               ...
               if (TSBDATA.CUSTOMER.Rows[i].Field<Nullable<DateTime>>("CUSTOMER_DOB") != null)
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_DATE_OF_BIRTH_MMDDYYYY", TSBDATA.CUSTOMER.Rows[i].Field<DateTime>("CUSTOMER_DOB"));
               // Strip ,s from STREET_1 AND STREET_2 if they exist
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_STREET_1", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_STREET_1").Replace(",", " ").Replace("#"," "));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_STREET_2", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_STREET_2").PadRight(20).Substring(0, 20).Replace(",", " "));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_CITY", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_CITY"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_STATE", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_STATE"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_ZIP_1", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_ZIP_1"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_ZIP_2", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_ZIP_2"));
               ...
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_FIRST_NAME", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_FIRST_NAME").Replace(@"'", ""));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_LAST_NAME", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_LAST_NAME").Replace(@"'", ""));
               switch (TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_JUNIOR").TrimStart().TrimEnd().ToUpper())
               {
                   case "SR":
                   case "I":
                   case "1":
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_JUNIOR", "S");
                       break;
                   case "JR":
                   case "II":
                   case "2":
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_JUNIOR", "J");
                       break;
                   case "III":
                   case "3":
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_JUNIOR", "3");
                       break;
                   default:
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_JUNIOR",
                           TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_JUNIOR").TrimStart().TrimEnd().ToUpper());
                       break;

               }
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_HOME_PHONE", (Program.IsInteger(TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_HOME_PHONE"))) ? TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_HOME_PHONE") : " ".PadRight(10));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_WORK_PHONE", (Program.IsInteger(TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_WORK_PHONE"))) ? TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_WORK_PHONE") : " ".PadRight(10));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_CELL_PHONE", (Program.IsInteger(TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_CELL_PHONE"))) ? TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_CELL_PHONE") : " ".PadRight(10));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_SS_NUMBER", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_SS1") +
                   TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_SS2") + TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_SS3"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_ADDRESS1", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_ADDRESS1").Replace(",", " ").Replace("#"," "));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_CITY", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_CITY"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_STATE", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_STATE"));
               // Replace - with space from zip+4 if it is there
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_ZIP_CODE", TSBDATA.CUSTOMER.Rows[i].Field<String>("COSIGNER_ZIP_CODE").Replace("-", " "));
               // Zero pad Birth date to 8 0's if no birth date.
               if (TSBDATA.CUSTOMER.Rows[i].Field<Nullable<DateTime>>("COSIGNER_DOB_DATE") != null)
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_COSIGN_DOB_DATE",
                       TSBDATA.CUSTOMER.Rows[i].Field<DateTime>("COSIGNER_DOB_DATE"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_COUNTRY", "US");
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_ADDRESS_IND", " ");
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCOUNT_NUMBER", TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_NO").PadRight(30, ' '));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_RESIDENCE_CODE", " ");
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_TYPE_CODE", (TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_INSURANCE").ToUpper() == "Y") ? "00" : "01");
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_STATUS_CODE", lsAcctStatusCode);
               ...
               if (lsAcctStatusCode == "11" || lsAcctStatusCode == "64" || lsAcctStatusCode == "71" || lsAcctStatusCode == "78" || lsAcctStatusCode == "80" ||
                   ...
                   lsAcctPaymentRating = " ";
               if (!TSBDATA.CUSTOMER.Rows[i].Field<Boolean>("TSBCodeOverride") || lsAcctPaymentRating == " ")
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_PAYMENT_RATING", lsAcctPaymentRating);
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_PAYMENT_RATING", TSBDATA.CUSTOMER.Rows[i].Field<String>("TSBPaymentRating"));
               ...
               if (lsAcctStatusCode == "93" && 
                    ...
                    TSBDATA.CUSTOMER.Rows[i].Field<Nullable<Decimal>>("CUSTOMER_PREV_BALANCE") != null)
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CURRENT_BAL", TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_PREV_BALANCE"));
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CURRENT_BAL", TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_BALANCE"));
               ...
               if (TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_CONTRACT_STATUS") < 0 && lsAcctStatusCode != "11" && TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_BALANCE") > 0)
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_AMOUNT_PAST_DUE", TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_CONTRACT_STATUS") * -1);
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_AMOUNT_PAST_DUE", 0);

               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Int32>("CRDMGR_ACCT_BILLING_DAY",
               ...
               {
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_ACCT_DATE_OPENED",
                       TSBDATA.ClosedWSHIST.Rows[0].Field<Nullable<DateTime>>("HIST_DATE_OPENED"));
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_DATE_LAST_PAYMENT",
                   ...
                   if (TSBDATA.ClosedWSHIST.Rows[0].Field<Nullable<Decimal>>("HIST_PAYMENT_AMOUNT") != null)
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACTUAL_PAYMENT_AMOUNT",
                           TSBDATA.ClosedWSHIST.Rows[0].Field<Decimal>("HIST_PAYMENT_AMOUNT"));
                   else
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACTUAL_PAYMENT_AMOUNT", 0);
                   if (TSBDATA.ClosedWSHIST.Rows[0].Field<Nullable<Decimal>>("HIST_HIGHEST_CREDIT") == null ||
                       ...
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_HIGHEST_CREDIT",
                   ...
                   if (TSBDATA.ClosedWSHIST.Rows[0].Field<DateTime?>("HIST_DATE_OF_FIRST_DELINQUENT") != null && lsAcctStatusCode != "11" && lsAcctStatusCode != "13")
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime?>("CRDMGR_DATE_FIRST_DELINQUENT",
                       ...
                       //if(lsAcctStatusCode == "97")
                           //TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_DATE_FIRST_DELINQUENT",
                               //TSBDATA.ClosedWSHIST.Rows[0].Field<Nullable<DateTime>>("HIST_DATE_LAST_PAYMENT"));
                       //else
                           TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_DATE_FIRST_DELINQUENT", null);
               }
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_ACCT_DATE_CLOSED",
                   null);
               ...
               if (lsAcctStatusCode == "13" &&
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<Nullable<DateTime>>("CRDMGR_DATE_LAST_PAYMENT") == null)
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_DATE_LAST_PAYMENT",
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<DateTime>("CRDMGR_ACCT_DATE_CLOSED"));
               if (TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<Nullable<DateTime>>("CRDMGR_DATE_FIRST_DELINQUENT") != null)
               {
                   if (TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<DateTime>("CRDMGR_DATE_FIRST_DELINQUENT") <=
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<DateTime>("CRDMGR_ACCT_DATE_OPENED"))
                       TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_DATE_FIRST_DELINQUENT",
                           null);
               }
               ...
               if (TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_ACT_STAT") == "I" && (TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_BALANCE") <= 0) || lsAcctStatusCode == "13")
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_SCHED_MONTHLY_PAYMENT", 0);
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_SCHED_MONTHLY_PAYMENT",
                        TSBDATA.CUSTOMER.Rows[i].Field<Decimal>("CUSTOMER_REGULAR_AMOUNT"));
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CREDIT_LIMIT", 0);

               lsTSBCommentCode = TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_TSB_COMMENT_CODE").TrimEnd();
               if (lsTSBCommentCode == "1" | lsTSBCommentCode == "2" || lsTSBCommentCode == "5" || lsTSBCommentCode == "T" || lsTSBCommentCode == "W" ||
                   lsTSBCommentCode == "X" || lsTSBCommentCode == "Z")
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_ECOA_CODE", lsTSBCommentCode.PadRight(2, ' '));
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_ECOA_CODE", "1");
               ...
               {
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_ECOA_CODE", "2");
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_ECOA_CODE", "2");
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_COSIGN_COUNTRY_CODE", "US");
               }
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_PORTFOLIO_TYPE", "I");
               if (TSBDATA.ClosedWSHIST.Rows.Count > 0)
               {
                    ...
                    {
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ORIGINAL_CHARGE_OFF_AMT",
                            TSBDATA.ClosedWSHIST.Rows[0].Field<Decimal>("HIST_CHARGE_OFF_AMOUNT"));
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_AMOUNT_PAST_DUE",
                            TSBDATA.ClosedWSHIST.Rows[0].Field<Decimal>("HIST_CHARGE_OFF_AMOUNT"));
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CURRENT_BAL",
                            TSBDATA.ClosedWSHIST.Rows[0].Field<Decimal>("HIST_CHARGE_OFF_AMOUNT"));
                    }
                    else
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ORIGINAL_CHARGE_OFF_AMT", 0);
               }
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ORIGINAL_CHARGE_OFF_AMT", 0);
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_TERMS_FREQUENCY", "M");
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Int32>("CRDMGR_ACCT_TERMS_DURATION",
                   TSBDATA.CUSTOMER.Rows[i].Field<Int32>("CUSTOMER_TERM"));
               if (lsTSBCommentCode == "B"  || lsTSBCommentCode == "C"  || lsTSBCommentCode == "AB" || lsTSBCommentCode == "AC" || lsTSBCommentCode == "AJ" ||
                   lsTSBCommentCode == "AM" || lsTSBCommentCode == "AS" || lsTSBCommentCode == "AU" || lsTSBCommentCode == "AZ" || lsTSBCommentCode == "BF" ||
                   lsTSBCommentCode == "BG" || lsTSBCommentCode == "BH" || lsTSBCommentCode == "BI" || lsTSBCommentCode == "BJ" || lsTSBCommentCode == "BK" ||
                   lsTSBCommentCode == "BN" || lsTSBCommentCode == "BP")
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_SPECIAL_COMMENT_CODE", lsTSBCommentCode.PadRight(2, ' '));
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_SPECIAL_COMMENT_CODE", "  ");
               ...
               if (lsTSBCommentCode == "A" || lsTSBCommentCode == "D" || lsTSBCommentCode == "E" || lsTSBCommentCode == "H" || lsTSBCommentCode == "I" ||
                   ...
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CONSUMER_INDICATOR", lsTSBCommentCode);
               else
                   TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CONSUMER_INDICATOR", " ");
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("PaymentProfile",
               ...
               TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Boolean>("Report", (TSBDATA.CUSTOMER.Rows[i].Field<String>("CUSTOMER_CREDIT_BUREAU") == "Y") ? true : false);
               ClosedCreditManagerBindingSource.EndEdit();
               try
               {
                   ClosedCreditManagerTableAdapter.Update(TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position]);
               }
               catch (Exception ex)
               {
            ...
            for (Int32 i = 0; i < TSBDATA.OPNCUST.Rows.Count; i++)
            {
                ...
                ClosedCreditManagerBindingSource.EndEdit();
                // Strip apostrophes from first and last name if they exist
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_FIRST_NAME", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_FIRST_NAME").Replace(@"'", ""));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_LAST_NAME", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_LAST_NAME").Replace(@"'", ""));
                // Moses Newman 06/05/2020 No Middle Name yet in Open End.
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("MiddleName", "");
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_SS_NUMBER",
                ...
                if (TSBDATA.OPNCUST.Rows[i].Field<Nullable<DateTime>>("CUSTOMER_DOB_DATE") != null)
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_DATE_OF_BIRTH_MMDDYYYY", TSBDATA.OPNCUST.Rows[i].Field<DateTime>("CUSTOMER_DOB_DATE"));
                // Strip ,s from STREET_1 AND STREET_2 if they exist
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_STREET_1", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_STREET_1").Replace(",", " ").Replace("#"," "));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_STREET_2", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_STREET_2").PadRight(20).Substring(0, 20).Replace(",", " "));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_CITY", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_CITY"));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_STATE", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_STATE"));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_ZIP_1", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_ZIP_1"));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_ZIP_2", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_ZIP_2"));
                ...
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_COUNTRY", "US");
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_ADDRESS_IND", " ");
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCOUNT_NUMBER", TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_NO").PadRight(30, ' '));
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_CUST_RESIDENCE_CODE", " ");
                // Moses Newman 06/04/2015 Account_type must be 07 for Revolving portfolio type (Open End)
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_TYPE_CODE", "07");
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_STATUS_CODE", lsAcctStatusCode);
                // Moses Newman 06/05/2015 Handle blank payment rating
                if (lsAcctStatusCode == "11" || lsAcctStatusCode == "64" || lsAcctStatusCode == "71" || lsAcctStatusCode == "78" || lsAcctStatusCode == "80" ||
                    lsAcctStatusCode == "82" || lsAcctStatusCode == "83" || lsAcctStatusCode == "84" || lsAcctStatusCode == "93" || lsAcctStatusCode == "97")
                ...
                if (lsAcctStatusCode == "93" && TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_ACT_STAT") == "I" && TSBDATA.OPNCUST.Rows[i].Field<Decimal>("CUSTOMER_BALANCE") == 0)
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CURRENT_BAL", TSBDATA.OPNCUST.Rows[i].Field<Decimal>("CUSTOMER_PREV_BALANCE"));
                else
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CURRENT_BAL", TSBDATA.OPNCUST.Rows[i].Field<Decimal>("CUSTOMER_BALANCE"));
                ...
                if (TSBDATA.OPNCUST.Rows[i].Field<Decimal>("CUSTOMER_CONTRACT_STATUS") < 0 && lsAcctStatusCode != "11" && TSBDATA.OPNCUST.Rows[i].Field<Decimal>("CUSTOMER_BALANCE") > 0)
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_AMOUNT_PAST_DUE", lnOpenPastDue);
                else
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_AMOUNT_PAST_DUE", 0);
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Int32>("CRDMGR_ACCT_BILLING_DAY",
                ...
                /*  Moses Newman 06/08/2015 Don't Mess With First Delinquent!
                if (TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<Nullable<DateTime>>("CRDMGR_DATE_FIRST_DELINQUENT") == null)
                    if ((TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_ACT_STAT") == "A" && (lsAcctStatusCode == "71" || lsAcctStatusCode == "78" ||
                        lsAcctStatusCode == "80" || lsAcctStatusCode == "82" || lsAcctStatusCode == "83" || lsAcctStatusCode == "84" || lsAcctStatusCode == "93") &&
                        lnDateDiff > 29) ||
                        ((lsAcctStatusCode == "62" || lsAcctStatusCode == "64" ||
                        lsAcctStatusCode == "97" || (lsAcctStatusCode == "93" && TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_ACT_STAT") == "I") ||
                        (lsAcctStatusCode == "13" && lsAcctPaymentRating != "0"))))
                    {
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_DATE_FIRST_DELINQUENT",
                            OpenNextDueDate(i, TSBDATA));
                        if (TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<DateTime>("CRDMGR_DATE_FIRST_DELINQUENT").Month == 1 &&
                            TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<DateTime>("CRDMGR_DATE_FIRST_DELINQUENT").Year == 2000)
                            TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_DATE_FIRST_DELINQUENT",
                                      TSBDATA.OPNCUST.Rows[i].Field<DateTime>("CUSTOMER_INIT_DATE"));
                    }*/
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_ACCT_DATE_CLOSED",
                    null);
                if (TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_ACT_STAT") == "I")
                    if(lsAcctStatusCode != "11" && TSBDATA.OPNCUST.Rows[i].Field<Nullable<DateTime>>("CUSTOMER_LAST_PAYMENT_DATE") <= (DateTime)nullableDateTimePickerTo.Value) 
                        ...
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Nullable<DateTime>>("CRDMGR_ACCT_DATE_CLOSED",null);
                if (lsAcctStatusCode == "13" &&
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<Nullable<DateTime>>("CRDMGR_DATE_LAST_PAYMENT") == null &&
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<Nullable<DateTime>>("CRDMGR_ACCT_DATE_OPENED") != null)
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<DateTime>("CRDMGR_DATE_LAST_PAYMENT",
                        TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<DateTime>("CRDMGR_ACCT_DATE_OPENED"));
                if (TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].Field<Nullable<DateTime>>("CRDMGR_DATE_FIRST_DELINQUENT") != null)
                {
                ...
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ACCT_CREDIT_LIMIT",
                    (Decimal)TSBDATA.OPNCUST.Rows[i].Field<Int32>("CUSTOMER_CREDIT_LIMIT"));
                ...
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_PORTFOLIO_TYPE", "R");
                ...
                {                    
                    ...
                    TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Decimal>("CRDMGR_ORIGINAL_CHARGE_OFF_AMT", 0);
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_TERMS_FREQUENCY", "M");
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<String>("CRDMGR_ACCT_TERMS_DURATION","REV");
                if (lsTSBCommentCode == "B" || lsTSBCommentCode == "C" || lsTSBCommentCode == "AB" || lsTSBCommentCode == "AC" || lsTSBCommentCode == "AJ" ||
                    lsTSBCommentCode == "AM" || lsTSBCommentCode == "AS" || lsTSBCommentCode == "AU" || lsTSBCommentCode == "AZ" || lsTSBCommentCode == "BF" ||
                    lsTSBCommentCode == "BG" || lsTSBCommentCode == "BH" || lsTSBCommentCode == "BI" || lsTSBCommentCode == "BJ" || lsTSBCommentCode == "BK" ||
                    lsTSBCommentCode == "BN" || lsTSBCommentCode == "BP")
                ...
                // Moses Newman 06/11/2020 added Report
                TSBDATA.ClosedCreditManager.Rows[ClosedCreditManagerBindingSource.Position].SetField<Boolean>("Report", (TSBDATA.OPNCUST.Rows[i].Field<String>("CUSTOMER_CREDIT_BUREAU") == "Y") ? true : false);
