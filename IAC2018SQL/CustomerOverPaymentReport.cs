...
{
    public partial class CustomerOverPaymentReport : DevExpress.XtraEditors.XtraForm
    {
        public CustomerOverPaymentReport()
        {
            InitializeComponent();
        }
        ...
        private void buttonPrint_Click(object sender, EventArgs e)
        {
            ...
            IACDataSetTableAdapters.ClosedCustomerOverPaymentsTableAdapter ClosedCustomerOverPaymentsAdapter = new IACDataSetTableAdapters.ClosedCustomerOverPaymentsTableAdapter();

            ClosedCustomerOverPaymentsAdapter.Fill(ReportDataSet.ClosedCustomerOverPayments);

            if (ReportDataSet.ClosedCustomerOverPayments.Rows.Count == 0)
                MessageBox.Show("*** Sorry there are no Customers with Over Payment! ***");
            else
            {
                String  lsUNCROOT = Program.GsDataPath,
                        lsNewFileOut = lsUNCROOT + @"AccStuff\mfdata\EXCLDATA\OverPayment" + DateTime.Now.Date.Year.ToString() + DateTime.Now.Date.Month.ToString().PadLeft(2, '0') + DateTime.Now.Date.Day.ToString().PadLeft(2, '0') + @".xlsx";
