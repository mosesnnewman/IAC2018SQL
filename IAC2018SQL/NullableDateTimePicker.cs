...
namespace ProManApp
{
    ...
    public partial class NullableDateTimePicker : DateTimePicker, ISupportInitialize
    {
        ...
        public void EndInit()
        {
            ...
            do
            {
                ...
                if (parent.GetType().IsSubclassOf(typeof(UserControl)))
                {
                    ...
                    ((UserControl)parent).Load += new EventHandler(NullableDateTimePicker_Load);
                ...
                else if (parent.GetType().IsSubclassOf(typeof(Form)))
                {
                    ...
                    ((Form)parent).Load += new EventHandler(NullableDateTimePicker_Load);
        ...
        void NullableDateTimePicker_Load(object sender, EventArgs e)
        {
        ...
        private struct NMHDR
        {
            ...
            public IntPtr idFrom;  // Moses Newman 09/04/2021 goes from int in win32 to IntPtr in Win64!!!
