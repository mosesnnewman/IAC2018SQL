...
{
    public partial class frmClosedMasterContingentPost : Form
    {
        ...
        public frmClosedMasterContingentPost()
        {
            InitializeComponent();
        }

        private void frmClosedMasterContingentPost_Load(object sender, EventArgs e)
        {
            PerformAutoScale();
        }
        ...
        private void PostContingents()
        {
            ...
            // Moses Newman 05/2/2014 Get rid of SQL PASS THROUGH!
            MACONTTableAdapter.FillByAll(ContingiacDataSet.MACONT);
            if (ContingiacDataSet.MACONT.Rows.Count == 0)
            {
                MessageBox.Show("There are no unposted MASTER contingent records!");
                return;
            }

            MACONTTableAdapter.CloseConnection();
            ...
            // Moses Newman 05/3/2014 get rid of SQL Pass Through!
            MASTERTableAdapter.UpdateFromMacont(DateTime.Now.Date);
            worker.ReportProgress(50);

            CreateMastHist();
            worker.ReportProgress(75);

            MACONTTableAdapter.DeleteAllRecords();
            MACONTTableAdapter.Dispose();
        ...
        private void buttonPost_Click(object sender, EventArgs e)
        {
            ...
            lfrm.Text = "Closed Master Contingent Posting";
            lfrm.lblProgress.Text = "Posting Closed Master Contingents";
            lfrm.ShowDialog();
        }
