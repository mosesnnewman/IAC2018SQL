                ...
                if (lbEdit)
                {
                    ...
                    if (iACDataSet.CUSTOMER.Rows[cUSTOMERBindingSource.Position].Field<String>("CUSTOMER_INT_OVERRIDE") == "Y" && !lbAlreadyIntOverride)
                    {
                        ...
                        if (!lbInterestOveride)
                        {
                            ...
                            iACDataSet.CUST<?xml version="1.0" encoding="utf-8"?>
<xs:schema id="NewDataSet" xmlns="" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:msdata="urn:schemas-microsoft-com:xml-msdata" xmlns:msprop="urn:schemas-microsoft-com:xml-msprop">
  <xs:annotation>
    <xs:appinfo source="urn:schemas-microsoft-com:xml-msdatasource">
      <DataSource DefaultConnectionIndex="0" FunctionsComponentName="QueriesTableAdapter" Modifier="AutoLayout, AnsiClass, Class, Public" SchemaSerializationMode="IncludeSchema" xmlns="urn:schemas-microsoft-com:xml-msdatasource">
        <ConnectionRefs>
          <DesignConnectionRef Name="IAC2010SQLConnectionString (Settings)" />
        </ConnectionRefs>
        <Connections>
          <Connection AppSettingsObjectName="Settings" AppSettingsPropertyName="IAC2010SQLConnectionString" ConnectionStringObject="" IsAppSettingsProperty="true" Modifier="Assembly" Name="IAC2010SQLConnectionString (Settings)" ParameterPrefix="@" PropertyReference="ApplicationSettings.IAC2021SQL.Properties.Settings.GlobalReference.Default.IAC2010SQLConnectionString" Provider="Microsoft.Data.SqlClient" />
        </Connections>
        <TableRefs>
          <DesignTableRef Name="CUSTHIST">
            <ColumnRefs />
            <SourceRefs />
          </DesignTableRef>
        </TableRefs>
        <Tables>
          <TableAdapter BaseClass="System.ComponentModel.Component" DataAccessorModifier="AutoLayout, AnsiClass, Class, Public" DataAccessorName="CUSTHISTTableAdapter" GeneratorDataComponentClassName="CUSTHISTTableAdapter" Name="CUSTHIST" UserDataComponentName="CUSTHISTTableAdapter">
            <MainSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLTEST.dbo.ClosedCustomerHistorySelect" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="Fill" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetData" GeneratorSourceName="Fill" GetMethodModifier="Public" GetMethodName="GetData" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetData" UserSourceName="Fill">
                <DeleteCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryDelete</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumn="CUSTHIST_NO" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumn="CUSTHIST_PAY_DATE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@CUSTHIST_DATE_SEQ" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="CUSTHIST_DATE_SEQ" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </DeleteCommand>
                <InsertCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryInsert</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumn="CUSTHIST_NO" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_ADD_ON" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_ADD_ON" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_IAC_TYPE" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_IAC_TYPE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumn="CUSTHIST_PAY_DATE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@CUSTHIST_DATE_SEQ" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="CUSTHIST_DATE_SEQ" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@TransactionDate" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumn="TransactionDate" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="bit" DbType="Boolean" Direction="Input" ParameterName="@FromIVR" Precision="1" ProviderType="Bit" Scale="0" Size="1" SourceColumn="FromIVR" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@Fee" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumn="Fee" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_ISF_DATE" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumn="CUSTHIST_ISF_DATE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_ACT_STAT" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_ACT_STAT" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_BUY_OUT" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_BUY_OUT" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_BALANCE" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_BALANCE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_PAYMENT_RCV" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_PAYMENT_RCV" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_PAID_DISCOUNT" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_PAID_DISCOUNT" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_PAID_INTEREST" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_PAID_INTEREST" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_LATE_CHARGE" Precision="5" ProviderType="Decimal" Scale="2" Size="5" SourceColumn="CUSTHIST_LATE_CHARGE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_LATE_CHARGE_BAL" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_LATE_CHARGE_BAL" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_BUYOUT" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_BUYOUT" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_PAID_THRU" Precision="0" ProviderType="VarChar" Scale="0" Size="4" SourceColumn="CUSTHIST_PAID_THRU" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_PAY_REM_1" Precision="0" ProviderType="VarChar" Scale="0" Size="5" SourceColumn="CUSTHIST_PAY_REM_1" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@CUSTHIST_PAY_REM_2" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="CUSTHIST_PAY_REM_2" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_CONTRACT_STATUS" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_CONTRACT_STATUS" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_THRU_UD" Precision="5" ProviderType="Decimal" Scale="1" Size="5" SourceColumn="CUSTHIST_THRU_UD" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_ANNUAL_INTEREST" Precision="5" ProviderType="Decimal" Scale="1" Size="5" SourceColumn="CUSTHIST_ANNUAL_INTEREST" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_PREV_BALANCE" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_PREV_BALANCE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_FINANCE_CHARGE" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_FINANCE_CHARGE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_PAID" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_PAID" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_YTD_LATE_CHARGE" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_YTD_LATE_CHARGE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_TD_FINANCE_CHARGE" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_TD_FINANCE_CHARGE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_YTD_FINANCE_CHARGE" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_YTD_FINANCE_CHARGE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_PAYMENT_TYPE" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_PAYMENT_TYPE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_PAYMENT_CODE" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_PAYMENT_CODE" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_AUTO_PAY" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_AUTO_PAY" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_CURR_INT" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_CURR_INT" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@CUSTHIST_LATE_CHARGE_PAID" Precision="11" ProviderType="Decimal" Scale="2" Size="9" SourceColumn="CUSTHIST_LATE_CHARGE_PAID" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="bit" DbType="Boolean" Direction="Input" ParameterName="@IsSimple" Precision="1" ProviderType="Bit" Scale="0" Size="1" SourceColumn="IsSimple" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="numeric" DbType="Decimal" Direction="Input" ParameterName="@TVRateChange" Precision="5" ProviderType="Decimal" Scale="3" Size="5" SourceColumn="TVRateChange" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@PartialPayment" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumn="PartialPayment" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@ISFSeqNo" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="ISFSeqNo" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@ISFPaymentType" Precision="0" ProviderType="Char" Scale="0" Size="1" SourceColumn="ISFPaymentType" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@ISFPaymentCode" Precision="0" ProviderType="Char" Scale="0" Size="1" SourceColumn="ISFPaymentCode" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@PaymentSeq" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="PaymentSeq" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@ISFID" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="ISFID" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="bit" DbType="Boolean" Direction="Input" ParameterName="@IsINSUF" Precision="1" ProviderType="Bit" Scale="0" Size="1" SourceColumn="IsINSUF" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@LastMonthEndBalance" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumn="LastMonthEndBalance" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@AccruedInterest" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumn="AccruedInterest" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@MonthEndBalanceChange" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumn="MonthEndBalanceChange" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@ChangeDueToISF" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumn="ChangeDueToISF" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@TicketID" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="TicketID" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@TicketDetailID" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="TicketDetailID" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@PNSRef" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumn="PNSRef" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@PNSPayMethod" Precision="0" ProviderType="VarChar" Scale="0" Size="4" SourceColumn="PNSPayMethod" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@PNSSErvice" Precision="0" ProviderType="VarChar" Scale="0" Size="10" SourceColumn="PNSService" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@PNSTransactionDate" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumn="PNSTransactionDate" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </InsertCommand>
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistorySelect</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@CUSTHIST_DATE_SEQ" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
                <UpdateCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryUpdate</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumn="CUSTHIST_NO" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_ADD_ON" Precision="0" ProviderType="VarChar" Scale="0" Size="1" SourceColumn="CUSTHIST_ADD_ON" SourceColumnNullMapping="false" SourceVersion="Current" />
            ...
            <Mappings>
              <Mapping SourceColumn="CUSTHIST_NO" DataSetColumn="CUSTHIST_NO" />
              <Mapping SourceColumn="CUSTHIST_ADD_ON" DataSetColumn="CUSTHIST_ADD_ON" />
              <Mapping SourceColumn="CUSTHIST_IAC_TYPE" DataSetColumn="CUSTHIST_IAC_TYPE" />
              <Mapping SourceColumn="CUSTHIST_PAY_DATE" DataSetColumn="CUSTHIST_PAY_DATE" />
              <Mapping SourceColumn="CUSTHIST_DATE_SEQ" DataSetColumn="CUSTHIST_DATE_SEQ" />
              <Mapping SourceColumn="CUSTHIST_ACT_STAT" DataSetColumn="CUSTHIST_ACT_STAT" />
              <Mapping SourceColumn="CUSTHIST_BUY_OUT" DataSetColumn="CUSTHIST_BUY_OUT" />
              <Mapping SourceColumn="CUSTHIST_BALANCE" DataSetColumn="CUSTHIST_BALANCE" />
              <Mapping SourceColumn="CUSTHIST_PAYMENT_RCV" DataSetColumn="CUSTHIST_PAYMENT_RCV" />
              <Mapping SourceColumn="CUSTHIST_PAID_DISCOUNT" DataSetColumn="CUSTHIST_PAID_DISCOUNT" />
              <Mapping SourceColumn="CUSTHIST_PAID_INTEREST" DataSetColumn="CUSTHIST_PAID_INTEREST" />
              <Mapping SourceColumn="CUSTHIST_LATE_CHARGE" DataSetColumn="CUSTHIST_LATE_CHARGE" />
              <Mapping SourceColumn="CUSTHIST_LATE_CHARGE_BAL" DataSetColumn="CUSTHIST_LATE_CHARGE_BAL" />
              <Mapping SourceColumn="CUSTHIST_BUYOUT" DataSetColumn="CUSTHIST_BUYOUT" />
              <Mapping SourceColumn="CUSTHIST_PAID_THRU" DataSetColumn="CUSTHIST_PAID_THRU" />
              <Mapping SourceColumn="CUSTHIST_PAY_REM_1" DataSetColumn="CUSTHIST_PAY_REM_1" />
              <Mapping SourceColumn="CUSTHIST_PAY_REM_2" DataSetColumn="CUSTHIST_PAY_REM_2" />
              <Mapping SourceColumn="CUSTHIST_CONTRACT_STATUS" DataSetColumn="CUSTHIST_CONTRACT_STATUS" />
              <Mapping SourceColumn="CUSTHIST_THRU_UD" DataSetColumn="CUSTHIST_THRU_UD" />
              <Mapping SourceColumn="CUSTHIST_ANNUAL_INTEREST" DataSetColumn="CUSTHIST_ANNUAL_INTEREST" />
              <Mapping SourceColumn="CUSTHIST_PREV_BALANCE" DataSetColumn="CUSTHIST_PREV_BALANCE" />
              <Mapping SourceColumn="CUSTHIST_FINANCE_CHARGE" DataSetColumn="CUSTHIST_FINANCE_CHARGE" />
              <Mapping SourceColumn="CUSTHIST_PAID" DataSetColumn="CUSTHIST_PAID" />
              <Mapping SourceColumn="CUSTHIST_YTD_LATE_CHARGE" DataSetColumn="CUSTHIST_YTD_LATE_CHARGE" />
              <Mapping SourceColumn="CUSTHIST_TD_FINANCE_CHARGE" DataSetColumn="CUSTHIST_TD_FINANCE_CHARGE" />
              <Mapping SourceColumn="CUSTHIST_YTD_FINANCE_CHARGE" DataSetColumn="CUSTHIST_YTD_FINANCE_CHARGE" />
              <Mapping SourceColumn="CUSTHIST_PAYMENT_TYPE" DataSetColumn="CUSTHIST_PAYMENT_TYPE" />
              <Mapping SourceColumn="CUSTHIST_PAYMENT_CODE" DataSetColumn="CUSTHIST_PAYMENT_CODE" />
              <Mapping SourceColumn="CUSTHIST_AUTO_PAY" DataSetColumn="CUSTHIST_AUTO_PAY" />
              <Mapping SourceColumn="CUSTHIST_CURR_INT" DataSetColumn="CUSTHIST_CURR_INT" />
              <Mapping SourceColumn="SHORT_PAID_THRU" DataSetColumn="SHORT_PAID_THRU" />
              <Mapping SourceColumn="CUSTHIST_LATE_CHARGE_PAID" DataSetColumn="CUSTHIST_LATE_CHARGE_PAID" />
              <Mapping SourceColumn="CUSTHIST_ISF_DATE" DataSetColumn="CUSTHIST_ISF_DATE" />
              <Mapping SourceColumn="IsSimple" DataSetColumn="IsSimple" />
              <Mapping SourceColumn="IsArchive" DataSetColumn="IsArchive" />
              <Mapping SourceColumn="TVRateChange" DataSetColumn="TVRateChange" />
              <Mapping SourceColumn="PartialPayment" DataSetColumn="PartialPayment" />
              <Mapping SourceColumn="TransactionDate" DataSetColumn="TransactionDate" />
              <Mapping SourceColumn="FromIVR" DataSetColumn="FromIVR" />
              <Mapping SourceColumn="Fee" DataSetColumn="Fee" />
              <Mapping SourceColumn="ISFSeqNo" DataSetColumn="ISFSeqNo" />
              <Mapping SourceColumn="ISFPaymentType" DataSetColumn="ISFPaymentType" />
              <Mapping SourceColumn="ISFPaymentCode" DataSetColumn="ISFPaymentCode" />
              <Mapping SourceColumn="PaymentSeq" DataSetColumn="PaymentSeq" />
              <Mapping SourceColumn="TVDate" DataSetColumn="TVDate" />
              <Mapping SourceColumn="ID" DataSetColumn="ID" />
              <Mapping SourceColumn="ISFID" DataSetColumn="ISFID" />
              <Mapping SourceColumn="IsINSUF" DataSetColumn="IsINSUF" />
              <Mapping SourceColumn="LastMonthEndBalance" DataSetColumn="LastMonthEndBalance" />
              <Mapping SourceColumn="AccruedInterest" DataSetColumn="AccruedInterest" />
              <Mapping SourceColumn="MonthEndBalanceChange" DataSetColumn="MonthEndBalanceChange" />
              <Mapping SourceColumn="ChangeDueToISF" DataSetColumn="ChangeDueToISF" />
              <Mapping SourceColumn="TicketID" DataSetColumn="TicketID" />
              <Mapping SourceColumn="TicketDetailID" DataSetColumn="TicketDetailID" />
              <Mapping SourceColumn="PNSRef" DataSetColumn="PNSRef" />
              <Mapping SourceColumn="PNSPayMethod" DataSetColumn="PNSPayMethod" />
              <Mapping SourceColumn="PNSService" DataSetColumn="PNSService" />
              <Mapping SourceColumn="PNSTransactionDate" DataSetColumn="PNSTransactionDate" />
            </Mappings>
            <Sources>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistorySetISINSUF" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="ClosedCustomerHistorySetISINSUF" Modifier="Public" Name="ClosedCustomerHistorySetISINSUF" QueryType="NoData" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy" UserSourceName="ClosedCustomerHistorySetISINSUF">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistorySetISINSUF</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryTotalLatePaymentsbyDateRange" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="ClosedCustomerHistoryTotalLatePaymentsbyDateRange" Modifier="Public" Name="ClosedCustomerHistoryTotalLatePaymentsbyDateRange" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy1" UserSourceName="ClosedCustomerHistoryTotalLatePaymentsbyDateRange">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryTotalLatePaymentsbyDateRange</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE_FROM" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE_TO" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryContractDate" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="ContractDate" Modifier="Public" Name="ContractDate" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy2" UserSourceName="ContractDate">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryContractDate</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryContractStatus" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="ContractStatus" Modifier="Public" Name="ContractStatus" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy3" UserSourceName="ContractStatus">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryContractStatus</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CustomerNo" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      ...
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@PaidThrough" Precision="0" ProviderType="Char" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="money" DbType="Currency" Direction="Input" ParameterName="@PartialPayment" Precision="19" ProviderType="Money" Scale="4" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="bit" DbType="Boolean" Direction="Input" ParameterName="@UseCustStuff" Precision="1" ProviderType="Bit" Scale="0" Size="1" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedGetControlDate" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="ControlDate" Modifier="Public" Name="ControlDate" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy4" UserSourceName="ControlDate">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedGetControlDate</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.CUSTHIST" DbObjectType="Table" FillMethodModifier="Public" FillMethodName="CustomFillBy" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="CustomGetDataBy" GeneratorSourceName="CustomFillBy" GetMethodModifier="Public" GetMethodName="CustomGetDataBy" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="CustomGetDataBy" UserSourceName="CustomFillBy">
                <SelectCommand>
                  <DbCommand CommandType="Text" ModifiedByUser="false">
                    <CommandText>SELECT ID, CUSTHIST_NO, CUSTHIST_ADD_ON, CUSTHIST_IAC_TYPE, CUSTHIST_PAY_DATE, CUSTHIST_DATE_SEQ, TransactionDate, FromIVR, Fee, IsArchive, CUSTHIST_ISF_DATE, CUSTHIST_ACT_STAT, CUSTHIST_BUY_OUT, CUSTHIST_BALANCE, CUSTHIST_PAYMENT_RCV, CUSTHIST_PAID_DISCOUNT, CUSTHIST_PAID_INTEREST, CUSTHIST_LATE_CHARGE, CUSTHIST_LATE_CHARGE_BAL, CUSTHIST_BUYOUT, CUSTHIST_PAID_THRU, CUSTHIST_PAY_REM_1, CUSTHIST_PAY_REM_2, CUSTHIST_CONTRACT_STATUS, CUSTHIST_THRU_UD, CUSTHIST_ANNUAL_INTEREST, CUSTHIST_PREV_BALANCE, CUSTHIST_FINANCE_CHARGE, CUSTHIST_PAID, CUSTHIST_YTD_LATE_CHARGE, CUSTHIST_TD_FINANCE_CHARGE, CUSTHIST_YTD_FINANCE_CHARGE, CUSTHIST_PAYMENT_TYPE, CUSTHIST_PAYMENT_CODE, CUSTHIST_AUTO_PAY, CUSTHIST_CURR_INT, CUSTHIST_LATE_CHARGE_PAID, IsSimple, TVRateChange, PartialPayment, ISFSeqNo, ISFPaymentType, ISFPaymentCode, PaymentSeq, TVDate, ISFID, IsINSUF FROM CUSTHIST</CommandText>
                    <Parameters />
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="" DbObjectType="Unknown" GenerateShortCommands="true" GeneratorSourceName="CustomInsertQuery" Modifier="Public" Name="CustomInsertQuery" QueryType="NoData" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy5" UserSourceName="CustomInsertQuery">
                <InsertCommand>
                  <DbCommand CommandType="Text" ModifiedByUser="false">
                    <CommandText>INSERT INTO dbo.CUSTHIST (CUSTHIST_NO) VALUES(@CUSTHIST_NO)</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="false" AutogeneratedName="CUSTHIST_NO" ColumnName="CUSTHIST_NO" DataSourceName="" DataTypeServer="varchar(6)" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumn="CUSTHIST_NO" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </InsertCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="" DbObjectType="Unknown" GenerateShortCommands="true" GeneratorSourceName="CustomUpdateQuery" Modifier="Public" Name="CustomUpdateQuery" QueryType="NoData" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy6" UserSourceName="CustomUpdateQuery">
                <UpdateCommand>
                  <DbCommand CommandType="Text" ModifiedByUser="false">
                    <CommandText>UPDATE dbo.CUSTHIST SET CUSTHIST_PAY_REM_1 = @CUSTHIST_PAY_REM_1</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="CUSTHIST_PAY_REM_1" ColumnName="CUSTHIST_PAY_REM_1" DataSourceName="" DataTypeServer="varchar(5)" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_PAY_REM_1" Precision="0" ProviderType="VarChar" Scale="0" Size="5" SourceColumn="CUSTHIST_PAY_REM_1" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </UpdateCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="" DbObjectType="Unknown" GenerateShortCommands="true" GeneratorSourceName="DeleteQuery" Modifier="Public" Name="DeleteQuery" QueryType="NoData" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy7" UserSourceName="DeleteQuery">
                <DeleteCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryDelete</CommandText>
                    <Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryExtension" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="Extension" Modifier="Public" Name="Extension" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy8" UserSourceName="Extension">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryExtension</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryFillByCheckPayments" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByCheckPayments" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByCheckPayments" GeneratorSourceName="FillByCheckPayments" GetMethodModifier="Public" GetMethodName="GetDataByCheckPayments" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByCheckPayments" UserSourceName="FillByCheckPayments">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByCheckPayments</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryFillByCustomerNo" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByCustomerNo" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByCustomerNo" GeneratorSourceName="FillByCustomerNo" GetMethodModifier="Public" GetMethodName="GetDataByCustomerNo" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByCustomerNo" UserSourceName="FillByCustomerNo">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByCustomerNo</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION319.dbo.ClosedCustomerHistoryFillByEventDateAcct" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByEventDateAcct" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByEventDateAcct" GeneratorSourceName="FillByEventDateAcct" GetMethodModifier="Public" GetMethodName="GetDataByEventDateAcct" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByEventDateAcct" UserSourceName="FillByEventDateAcct">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByEventDateAcct</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      ...
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@Event" Precision="0" ProviderType="VarChar" Scale="0" Size="5" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@Seq" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryGetNewRecord" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByGetNewRecord" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByGetNewRecord" GeneratorSourceName="FillByGetNewRecord" GetMethodModifier="Public" GetMethodName="GetDataByGetNewRecord" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByGetNewRecord" UserSourceName="FillByGetNewRecord">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryGetNewRecord</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="TESTLC.dbo.ClosedCustomerHistoryFillByNonCheckPayments" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByNonCheckPayments" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByNonCheckPayments" GeneratorSourceName="FillByNonCheckPayments" GetMethodModifier="Public" GetMethodName="GetDataByNonCheckPayments" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByNonCheckPayments" UserSourceName="FillByNonCheckPayments">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByNonCheckPayments</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="varchar" DbType="AnsiString" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="VarChar" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryPaymentsSoFar" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByPaymentsSoFar" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByPaymentsSoFar" GeneratorSourceName="FillByPaymentsSoFar" GetMethodModifier="Public" GetMethodName="GetDataByPaymentsSoFar" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByPaymentsSoFar" UserSourceName="FillByPaymentsSoFar">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryPaymentsSoFar</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryPaymentsSoFarWithCutOff" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByPaymentsSoFarWithCutoff" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByPaymentsSoFarWithCutoff" GeneratorSourceName="FillByPaymentsSoFarWithCutoff" GetMethodModifier="Public" GetMethodName="GetDataByPaymentsSoFarWithCutoff" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByPaymentsSoFarWithCutoff" UserSourceName="FillByPaymentsSoFarWithCutoff">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryPaymentsSoFarWithCutOff</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUTOFF" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryFillByTicketDetailID" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByTicketDetailID" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByTicketDetailID" GeneratorSourceName="FillByTicketDetailID" GetMethodModifier="Public" GetMethodName="GetDataByTicketDetailID" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByTicketDetailID" UserSourceName="FillByTicketDetailID">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByTicketDetailID</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@TicketDetailID" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryFillByTicketID" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByTicketID" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByTicketID" GeneratorSourceName="FillByTicketID" GetMethodModifier="Public" GetMethodName="GetDataByTicketID" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByTicketID" UserSourceName="FillByTicketID">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByTicketID</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="Input" ParameterName="@TicketID" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryUpdatesOnlyByMonthYear" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="FillByUpdatesOnly" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByUpdatesOnly" GeneratorSourceName="FillByUpdatesOnly" GetMethodModifier="Public" GetMethodName="GetDataByUpdatesOnly" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByUpdatesOnly" UserSourceName="FillByUpdatesOnly">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryUpdatesOnlyByMonthYear</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@PayDate" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLTEST2.dbo.ClosedCustomerHistoryGetID" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="GetID" Modifier="Public" Name="GetID" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy9" UserSourceName="GetID">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryGetID</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryFillByLate" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="GetLate" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByGetLate" GeneratorSourceName="GetLate" GetMethodModifier="Public" GetMethodName="GetDataByGetLate" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByGetLate" UserSourceName="GetLate">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryFillByLate</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@Date" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryLastRateChangeZero" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="IsLastRateChangeZero" Modifier="Public" Name="IsLastRateChangeZero" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy10" UserSourceName="IsLastRateChangeZero">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryLastRateChangeZero</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryLastBalance" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="LastBalance" Modifier="Public" Name="LastBalance" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy11" UserSourceName="LastBalance">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryLastBalance</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryLastPowerCheckDate" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="LastPowerCheckDate" Modifier="Public" Name="LastPowerCheckDate" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy12" UserSourceName="LastPowerCheckDate">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryLastPowerCheckDate</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="nchar" DbType="StringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="NChar" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryLastRecord" DbObjectType="StoredProcedure" FillMethodModifier="Public" FillMethodName="LastRecord" GenerateMethods="Both" GenerateShortCommands="true" GeneratorGetMethodName="GetDataByLastRecord" GeneratorSourceName="LastRecord" GetMethodModifier="Public" GetMethodName="GetDataByLastRecord" QueryType="Rowset" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataByLastRecord" UserSourceName="LastRecord">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryLastRecord</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryLastTransactionDate" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="LastTransactionDate" Modifier="Public" Name="LastTransactionDate" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy13" UserSourceName="LastTransactionDate">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryLastTransactionDate</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryLastUPD" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="LastUPDDate" Modifier="Public" Name="LastUPDDate" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy14" UserSourceName="LastUPDDate">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryLastUPD</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.GetPaymentProfile" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="PaymentProfile" Modifier="Public" Name="PaymentProfile" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy15" UserSourceName="PaymentProfile">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.GetPaymentProfile</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CustomerNo" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@InfoDate" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
                  </DbCommand>
                </SelectCommand>
              </DbSource>
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistorySeqNoQuery" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="SeqNoQuery" Modifier="Public" Name="SeqNoQuery" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy16" UserSourceName="SeqNoQuery">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistorySeqNoQuery</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="datetime" DbType="DateTime" Direction="Input" ParameterName="@CUSTHIST_PAY_DATE" Precision="23" ProviderType="DateTime" Scale="3" Size="8" SourceColumnNullMapping="false" SourceVersion="Current" />
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryTotalLatePaymentsbyDateRange" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="TotalLatePaymentsbyDateRange" Modifier="Public" Name="TotalLatePaymentsbyDateRange" QueryType="Scalar" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy17" UserSourceName="TotalLatePaymentsbyDateRange">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryTotalLatePaymentsbyDateRange</CommandText>
                    <Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryUnflagLastPaidRecord" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="UnflagLastPaidRecord" Modifier="Public" Name="UnflagLastPaidRecord" QueryType="NoData" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy18" UserSourceName="UnflagLastPaidRecord">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryUnflagLastPaidRecord</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CUSTHIST_NO" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
              ...
              <DbSource ConnectionRef="IAC2010SQLConnectionString (Settings)" DbObjectName="IACSQLPRODUCTION.dbo.ClosedCustomerHistoryUpdateLastRecord" DbObjectType="StoredProcedure" GenerateShortCommands="true" GeneratorSourceName="UpdateLastRecord" Modifier="Public" Name="UpdateLastRecord" QueryType="NoData" ScalarCallRetval="System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" UseOptimisticConcurrency="true" UserGetMethodName="GetDataBy19" UserSourceName="UpdateLastRecord">
                <SelectCommand>
                  <DbCommand CommandType="StoredProcedure" ModifiedByUser="false">
                    <CommandText>dbo.ClosedCustomerHistoryUpdateLastRecord</CommandText>
                    <Parameters>
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="int" DbType="Int32" Direction="ReturnValue" ParameterName="@RETURN_VALUE" Precision="10" ProviderType="Int" Scale="0" Size="4" SourceColumnNullMapping="false" SourceVersion="Current" />
                      <Parameter AllowDbNull="true" AutogeneratedName="" DataSourceName="" DataTypeServer="char" DbType="AnsiStringFixedLength" Direction="Input" ParameterName="@CustomerNo" Precision="0" ProviderType="Char" Scale="0" Size="6" SourceColumnNullMapping="false" SourceVersion="Current" />
                    </Parameters>
  ...
  <xs:element name="NewDataSet" msdata:IsDataSet="true" msdata:UseCurrentLocale="true" msprop:Generator_UserDSName="NewDataSet" msprop:Generator_DataSetName="NewDataSet">
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:element name="CUSTHIST" msprop:Generator_RowEvHandlerName="CUSTHISTRowChangeEventHandler" msprop:Generator_RowDeletedName="CUSTHISTRowDeleted" msprop:Generator_RowDeletingName="CUSTHISTRowDeleting" msprop:Generator_RowEvArgName="CUSTHISTRowChangeEvent" msprop:Generator_TablePropName="CUSTHIST" msprop:Generator_RowChangedName="CUSTHISTRowChanged" msprop:Generator_RowChangingName="CUSTHISTRowChanging" msprop:Generator_TableClassName="CUSTHISTDataTable" msprop:Generator_RowClassName="CUSTHISTRow" msprop:Generator_TableVarName="tableCUSTHIST" msprop:Generator_UserTableName="CUSTHIST">
          <xs:complexType>
            <xs:sequence>
              <xs:element name="CUSTHIST_NO" msprop:Generator_ColumnPropNameInRow="CUSTHIST_NO" msprop:Generator_ColumnPropNameInTable="CUSTHIST_NOColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_NO" msprop:Generator_UserColumnName="CUSTHIST_NO" default="######">
                <xs:simpleType>
              ...
              <xs:element name="CUSTHIST_ADD_ON" msprop:Generator_ColumnPropNameInRow="CUSTHIST_ADD_ON" msprop:Generator_ColumnPropNameInTable="CUSTHIST_ADD_ONColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_ADD_ON" msprop:Generator_UserColumnName="CUSTHIST_ADD_ON" default=" " minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
              ...
              <xs:element name="CUSTHIST_IAC_TYPE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_IAC_TYPE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_IAC_TYPEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_IAC_TYPE" msprop:Generator_UserColumnName="CUSTHIST_IAC_TYPE" default="C" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_PAY_DATE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAY_DATE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAY_DATEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAY_DATE" msprop:Generator_UserColumnName="CUSTHIST_PAY_DATE" type="xs:dateTime" default="1980-01-01T00:00:00-05:00" />
              <xs:element name="CUSTHIST_DATE_SEQ" msprop:Generator_ColumnPropNameInRow="CUSTHIST_DATE_SEQ" msprop:Generator_ColumnPropNameInTable="CUSTHIST_DATE_SEQColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_DATE_SEQ" msprop:Generator_UserColumnName="CUSTHIST_DATE_SEQ" type="xs:int" default="0" />
              <xs:element name="CUSTHIST_ACT_STAT" msprop:Generator_ColumnPropNameInRow="CUSTHIST_ACT_STAT" msprop:Generator_ColumnPropNameInTable="CUSTHIST_ACT_STATColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_ACT_STAT" msprop:Generator_UserColumnName="CUSTHIST_ACT_STAT" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_BUY_OUT" msprop:Generator_ColumnPropNameInRow="CUSTHIST_BUY_OUT" msprop:Generator_ColumnPropNameInTable="CUSTHIST_BUY_OUTColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_BUY_OUT" msprop:Generator_UserColumnName="CUSTHIST_BUY_OUT" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_BALANCE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_BALANCE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_BALANCEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_BALANCE" msprop:Generator_UserColumnName="CUSTHIST_BALANCE" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_PAYMENT_RCV" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAYMENT_RCV" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAYMENT_RCVColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAYMENT_RCV" msprop:Generator_UserColumnName="CUSTHIST_PAYMENT_RCV" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_PAID_DISCOUNT" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAID_DISCOUNT" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAID_DISCOUNTColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAID_DISCOUNT" msprop:Generator_UserColumnName="CUSTHIST_PAID_DISCOUNT" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_PAID_INTEREST" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAID_INTEREST" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAID_INTERESTColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAID_INTEREST" msprop:Generator_UserColumnName="CUSTHIST_PAID_INTEREST" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_LATE_CHARGE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_LATE_CHARGE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_LATE_CHARGEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_LATE_CHARGE" msprop:Generator_UserColumnName="CUSTHIST_LATE_CHARGE" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_LATE_CHARGE_BAL" msprop:Generator_ColumnPropNameInRow="CUSTHIST_LATE_CHARGE_BAL" msprop:Generator_ColumnPropNameInTable="CUSTHIST_LATE_CHARGE_BALColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_LATE_CHARGE_BAL" msprop:Generator_UserColumnName="CUSTHIST_LATE_CHARGE_BAL" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_BUYOUT" msprop:Generator_ColumnPropNameInRow="CUSTHIST_BUYOUT" msprop:Generator_ColumnPropNameInTable="CUSTHIST_BUYOUTColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_BUYOUT" msprop:Generator_UserColumnName="CUSTHIST_BUYOUT" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_PAID_THRU" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAID_THRU" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAID_THRUColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAID_THRU" msprop:Generator_UserColumnName="CUSTHIST_PAID_THRU" type="xs:string" default="    " minOccurs="0" />
              <xs:element name="CUSTHIST_PAY_REM_1" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAY_REM_1" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAY_REM_1Column" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAY_REM_1" msprop:Generator_UserColumnName="CUSTHIST_PAY_REM_1" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
              ...
              <xs:element name="CUSTHIST_PAY_REM_2" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAY_REM_2" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAY_REM_2Column" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAY_REM_2" msprop:Generator_UserColumnName="CUSTHIST_PAY_REM_2" type="xs:int" minOccurs="0" />
              <xs:element name="CUSTHIST_CONTRACT_STATUS" msprop:nullValue="0" msprop:Generator_ColumnPropNameInTable="CUSTHIST_CONTRACT_STATUSColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_CONTRACT_STATUS" msprop:Generator_UserColumnName="CUSTHIST_CONTRACT_STATUS" msprop:Generator_ColumnPropNameInRow="CUSTHIST_CONTRACT_STATUS" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="CUSTHIST_THRU_UD" msprop:Generator_ColumnPropNameInRow="CUSTHIST_THRU_UD" msprop:Generator_ColumnPropNameInTable="CUSTHIST_THRU_UDColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_THRU_UD" msprop:Generator_UserColumnName="CUSTHIST_THRU_UD" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="CUSTHIST_ANNUAL_INTEREST" msprop:Generator_ColumnPropNameInRow="CUSTHIST_ANNUAL_INTEREST" msprop:Generator_ColumnPropNameInTable="CUSTHIST_ANNUAL_INTERESTColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_ANNUAL_INTEREST" msprop:Generator_UserColumnName="CUSTHIST_ANNUAL_INTEREST" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="CUSTHIST_PREV_BALANCE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PREV_BALANCE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PREV_BALANCEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PREV_BALANCE" msprop:Generator_UserColumnName="CUSTHIST_PREV_BALANCE" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_FINANCE_CHARGE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_FINANCE_CHARGE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_FINANCE_CHARGEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_FINANCE_CHARGE" msprop:Generator_UserColumnName="CUSTHIST_FINANCE_CHARGE" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_PAID" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAID" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAIDColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAID" msprop:Generator_UserColumnName="CUSTHIST_PAID" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_YTD_LATE_CHARGE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_YTD_LATE_CHARGE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_YTD_LATE_CHARGEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_YTD_LATE_CHARGE" msprop:Generator_UserColumnName="CUSTHIST_YTD_LATE_CHARGE" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_TD_FINANCE_CHARGE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_TD_FINANCE_CHARGE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_TD_FINANCE_CHARGEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_TD_FINANCE_CHARGE" msprop:Generator_UserColumnName="CUSTHIST_TD_FINANCE_CHARGE" type="xs:decimal" minOccurs="0" />
              <xs:element name="CUSTHIST_YTD_FINANCE_CHARGE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_YTD_FINANCE_CHARGE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_YTD_FINANCE_CHARGEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_YTD_FINANCE_CHARGE" msprop:Generator_UserColumnName="CUSTHIST_YTD_FINANCE_CHARGE" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="CUSTHIST_PAYMENT_TYPE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAYMENT_TYPE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAYMENT_TYPEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAYMENT_TYPE" msprop:Generator_UserColumnName="CUSTHIST_PAYMENT_TYPE" default="" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_PAYMENT_CODE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_PAYMENT_CODE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_PAYMENT_CODEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_PAYMENT_CODE" msprop:Generator_UserColumnName="CUSTHIST_PAYMENT_CODE" default="" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_AUTO_PAY" msprop:Generator_ColumnPropNameInRow="CUSTHIST_AUTO_PAY" msprop:Generator_ColumnPropNameInTable="CUSTHIST_AUTO_PAYColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_AUTO_PAY" msprop:Generator_UserColumnName="CUSTHIST_AUTO_PAY" default="N" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_CURR_INT" msprop:Generator_ColumnPropNameInRow="CUSTHIST_CURR_INT" msprop:Generator_ColumnPropNameInTable="CUSTHIST_CURR_INTColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_CURR_INT" msprop:Generator_UserColumnName="CUSTHIST_CURR_INT" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="SHORT_PAID_THRU" msprop:Generator_ColumnPropNameInRow="SHORT_PAID_THRU" msprop:Generator_ColumnPropNameInTable="SHORT_PAID_THRUColumn" msprop:Generator_ColumnVarNameInTable="columnSHORT_PAID_THRU" msprop:Generator_UserColumnName="SHORT_PAID_THRU" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="5" />
                  </xs:restriction>
              ...
              <xs:element name="CUSTHIST_LATE_CHARGE_PAID" msprop:Generator_ColumnPropNameInRow="CUSTHIST_LATE_CHARGE_PAID" msprop:Generator_ColumnPropNameInTable="CUSTHIST_LATE_CHARGE_PAIDColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_LATE_CHARGE_PAID" msprop:Generator_UserColumnName="CUSTHIST_LATE_CHARGE_PAID" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="CUSTHIST_ISF_DATE" msprop:Generator_ColumnPropNameInRow="CUSTHIST_ISF_DATE" msprop:Generator_ColumnPropNameInTable="CUSTHIST_ISF_DATEColumn" msprop:Generator_ColumnVarNameInTable="columnCUSTHIST_ISF_DATE" msprop:Generator_UserColumnName="CUSTHIST_ISF_DATE" type="xs:dateTime" minOccurs="0" />
              <xs:element name="IsSimple" msprop:Generator_ColumnPropNameInRow="IsSimple" msprop:Generator_ColumnPropNameInTable="IsSimpleColumn" msprop:Generator_ColumnVarNameInTable="columnIsSimple" msprop:Generator_UserColumnName="IsSimple" type="xs:boolean" default="true" minOccurs="0" />
              <xs:element name="IsArchive" msprop:Generator_ColumnPropNameInRow="IsArchive" msprop:Generator_ColumnPropNameInTable="IsArchiveColumn" msprop:Generator_ColumnVarNameInTable="columnIsArchive" msprop:Generator_UserColumnName="IsArchive" type="xs:boolean" default="false" minOccurs="0" />
              <xs:element name="TVRateChange" msprop:Generator_ColumnPropNameInRow="TVRateChange" msprop:Generator_ColumnPropNameInTable="TVRateChangeColumn" msprop:Generator_ColumnVarNameInTable="columnTVRateChange" msprop:Generator_UserColumnName="TVRateChange" type="xs:decimal" minOccurs="0" />
              <xs:element name="PartialPayment" msprop:Generator_ColumnPropNameInRow="PartialPayment" msprop:Generator_ColumnPropNameInTable="PartialPaymentColumn" msprop:Generator_ColumnVarNameInTable="columnPartialPayment" msprop:Generator_UserColumnName="PartialPayment" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="TransactionDate" msprop:Generator_ColumnPropNameInRow="TransactionDate" msprop:Generator_ColumnPropNameInTable="TransactionDateColumn" msprop:Generator_ColumnVarNameInTable="columnTransactionDate" msprop:Generator_UserColumnName="TransactionDate" type="xs:dateTime" minOccurs="0" />
              <xs:element name="FromIVR" msprop:Generator_ColumnPropNameInRow="FromIVR" msprop:Generator_ColumnPropNameInTable="FromIVRColumn" msprop:Generator_ColumnVarNameInTable="columnFromIVR" msprop:Generator_UserColumnName="FromIVR" type="xs:boolean" default="false" minOccurs="0" />
              <xs:element name="Fee" msprop:Generator_ColumnPropNameInRow="Fee" msprop:Generator_ColumnPropNameInTable="FeeColumn" msprop:Generator_ColumnVarNameInTable="columnFee" msprop:Generator_UserColumnName="Fee" type="xs:decimal" default="0" minOccurs="0" />
              <xs:element name="ISFSeqNo" msprop:Generator_ColumnPropNameInRow="ISFSeqNo" msprop:Generator_ColumnPropNameInTable="ISFSeqNoColumn" msprop:Generator_ColumnVarNameInTable="columnISFSeqNo" msprop:Generator_UserColumnName="ISFSeqNo" type="xs:int" default="0" minOccurs="0" />
              <xs:element name="ISFPaymentType" msprop:Generator_ColumnPropNameInRow="ISFPaymentType" msprop:Generator_ColumnPropNameInTable="ISFPaymentTypeColumn" msprop:Generator_ColumnVarNameInTable="columnISFPaymentType" msprop:Generator_UserColumnName="ISFPaymentType" default="" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="ISFPaymentCode" msprop:Generator_ColumnPropNameInRow="ISFPaymentCode" msprop:Generator_ColumnPropNameInTable="ISFPaymentCodeColumn" msprop:Generator_ColumnVarNameInTable="columnISFPaymentCode" msprop:Generator_UserColumnName="ISFPaymentCode" default="" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
                    <xs:maxLength value="1" />
                  </xs:restriction>
              ...
              <xs:element name="PaymentSeq" msprop:Generator_ColumnPropNameInRow="PaymentSeq" msprop:Generator_ColumnPropNameInTable="PaymentSeqColumn" msprop:Generator_ColumnVarNameInTable="columnPaymentSeq" msprop:Generator_UserColumnName="PaymentSeq" type="xs:int" default="0" minOccurs="0" />
              <xs:element name="TVDate" msprop:Generator_ColumnPropNameInRow="TVDate" msprop:Generator_ColumnPropNameInTable="TVDateColumn" msprop:Generator_ColumnVarNameInTable="columnTVDate" msprop:Generator_UserColumnName="TVDate" type="xs:dateTime" minOccurs="0" />
              <xs:element name="ID" msdata:ReadOnly="true" msdata:AutoIncrement="true" msdata:AutoIncrementSeed="-1" msdata:AutoIncrementStep="-1" msprop:Generator_ColumnPropNameInRow="ID" msprop:Generator_ColumnPropNameInTable="IDColumn" msprop:Generator_ColumnVarNameInTable="columnID" msprop:Generator_UserColumnName="ID" type="xs:int" />
              <xs:element name="ISFID" msprop:Generator_ColumnPropNameInRow="ISFID" msprop:Generator_ColumnPropNameInTable="ISFIDColumn" msprop:Generator_ColumnVarNameInTable="columnISFID" msprop:Generator_UserColumnName="ISFID" type="xs:int" default="0" minOccurs="0" />
              <xs:element name="IsINSUF" msprop:Generator_ColumnPropNameInRow="IsINSUF" msprop:Generator_ColumnPropNameInTable="IsINSUFColumn" msprop:Generator_ColumnVarNameInTable="columnIsINSUF" msprop:Generator_UserColumnName="IsINSUF" type="xs:boolean" default="false" minOccurs="0" />
              <xs:element name="LastMonthEndBalance" msprop:Generator_ColumnPropNameInRow="LastMonthEndBalance" msprop:Generator_ColumnPropNameInTable="LastMonthEndBalanceColumn" msprop:Generator_ColumnVarNameInTable="columnLastMonthEndBalance" msprop:Generator_UserColumnName="LastMonthEndBalance" type="xs:decimal" minOccurs="0" />
              <xs:element name="AccruedInterest" msprop:Generator_ColumnPropNameInRow="AccruedInterest" msprop:Generator_ColumnPropNameInTable="AccruedInterestColumn" msprop:Generator_ColumnVarNameInTable="columnAccruedInterest" msprop:Generator_UserColumnName="AccruedInterest" type="xs:decimal" minOccurs="0" />
              <xs:element name="MonthEndBalanceChange" msprop:Generator_ColumnPropNameInRow="MonthEndBalanceChange" msprop:Generator_ColumnPropNameInTable="MonthEndBalanceChangeColumn" msprop:Generator_ColumnVarNameInTable="columnMonthEndBalanceChange" msprop:Generator_UserColumnName="MonthEndBalanceChange" type="xs:decimal" minOccurs="0" />
              <xs:element name="ChangeDueToISF" msprop:Generator_ColumnPropNameInRow="ChangeDueToISF" msprop:Generator_ColumnPropNameInTable="ChangeDueToISFColumn" msprop:Generator_ColumnVarNameInTable="columnChangeDueToISF" msprop:Generator_UserColumnName="ChangeDueToISF" type="xs:decimal" minOccurs="0" />
              <xs:element name="TicketID" msprop:Generator_ColumnPropNameInRow="TicketID" msprop:Generator_ColumnPropNameInTable="TicketIDColumn" msprop:Generator_ColumnVarNameInTable="columnTicketID" msprop:Generator_UserColumnName="TicketID" type="xs:int" minOccurs="0" />
              <xs:element name="TicketDetailID" msprop:Generator_ColumnPropNameInRow="TicketDetailID" msprop:Generator_ColumnPropNameInTable="TicketDetailIDColumn" msprop:Generator_ColumnVarNameInTable="columnTicketDetailID" msprop:Generator_UserColumnName="TicketDetailID" type="xs:int" minOccurs="0" />
              <xs:element name="PNSRef" msprop:Generator_ColumnPropNameInRow="PNSRef" msprop:Generator_ColumnPropNameInTable="PNSRefColumn" msprop:Generator_ColumnVarNameInTable="columnPNSRef" msprop:Generator_UserColumnName="PNSRef" type="xs:int" minOccurs="0" />
              <xs:element name="PNSPayMethod" msprop:Generator_ColumnPropNameInRow="PNSPayMethod" msprop:Generator_ColumnPropNameInTable="PNSPayMethodColumn" msprop:Generator_ColumnVarNameInTable="columnPNSPayMethod" msprop:Generator_UserColumnName="PNSPayMethod" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
              ...
              <xs:element name="PNSService" msprop:Generator_ColumnPropNameInRow="PNSService" msprop:Generator_ColumnPropNameInTable="PNSServiceColumn" msprop:Generator_ColumnVarNameInTable="columnPNSService" msprop:Generator_UserColumnName="PNSService" minOccurs="0">
                <xs:simpleType>
                  <xs:restriction base="xs:string">
              ...
              <xs:element name="PNSTransactionDate" msprop:Generator_ColumnPropNameInRow="PNSTransactionDate" msprop:Generator_ColumnPropNameInTable="PNSTransactionDateColumn" msprop:Generator_ColumnVarNameInTable="columnPNSTransactionDate" msprop:Generator_UserColumnName="PNSTransactionDate" type="xs:dateTime" minOccurs="0" />
            </xs:sequence>
          </xs:complexType>
        </xs:element>
      </xs:choice>
    ...
    <xs:unique name="Constraint1" msdata:PrimaryKey="true">
      <xs:selector xpath=".//CUSTHIST" />
      <xs:field xpath="ID" />
    </xs:unique>
  </xs:element>
</xs:schema>HIST.Rows[cUSTHISTBindingSource.Position].SetField<Int32>("CUSTHIST_PAY_REM_2", iACDataSet.CUSTOMER.Rows[cUSTOMERBindingSource.Position].Field<Int32>("CUSTOMER_PAY_REM_2"));
